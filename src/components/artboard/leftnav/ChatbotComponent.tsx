...
export default function ChatbotComponent({ canvasRef }: ComponentProps) {
    ...
    return (
        <button
            ...
            onClick={() => handleAddShape("chatbot", canvasRef, view!.scale)}
            draggable
            onDragStart={(e) => {
                handleDragStart(e, "chatbot");
            }}
        >
            <div className="flex justify-center items-center hover:text-[#42A5F5]">
                <svg
                    width="20"
                    height="16"
                    viewBox="0 0 20 16"
            ...
            <p className="text-xs pt-5 pb-2">Chatbot</p>
        </button>
    );
}
