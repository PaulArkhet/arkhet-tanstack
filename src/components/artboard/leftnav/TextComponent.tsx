...
export default function TextComponent({ canvasRef }: ComponentProps) {
    ...
    return (
        <div
            ...
            onClick={() => handleAddShape("text", canvasRef, view!.scale)}
        >
            <HoverCard openDelay={400} closeDelay={0}>
                ...
                >
                    <p className="text-xs">
                        Press <span className="text-sm font-bold">t</span> to
                        add a text
                    </p>
                </HoverCardContent>
            </HoverCard>
